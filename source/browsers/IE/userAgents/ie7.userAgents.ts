...
export const ie7userAgents = {
  values: [
    ...
    'Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; .NET CLR 1.1.4322; o Mozilla/4.0 (compatible; MSIE 7.0 – Qwest 1.0; Windows NT 5.1; YPC 3.0.1; .NET CLR 1.1.4322; .NET CLR 2.0.50727))',
