...
import { safari311userAgents } from './userAgents/safari3-1-1.userAgents.js'
import { safari400userAgents } from './userAgents/safari4-0-0.userAgents.js'

export const userAgentsSafari: iUserAgent[] = [
  {
    values: [
  ...
  },
  {
    ...
    browser: {
      type: eBrowserType.safari,
      // NOTE: Research pre 3.0 releases
      version: 'pre 3.0',
      // version: '2.0.4',
    },
  },
  ...
  },
  {
    ...
    browser: {
      type: eBrowserType.safari,
      // NOTE: Research other releases
      // version: 'unknown'
      version: 'pre 3.0', // still returns this value but might be higher version
    },
  },
]
